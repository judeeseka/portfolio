        ...
        {projects.map((project) => (
          <CardContainer key={project.id}>
            <CardBody className="bg-gray-50 group/card  dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-full h-auto rounded-xl p-6 border ">
              ...
              <CardItem
                translateZ={50}
                className="mt-4 text-sm uppercase tracking-wide text-emerald-300/90"
              >
                {project.productType}
              </CardItem>
              <CardItem
              ...
              <CardItem
                as="p"
                translateZ={60}
                className="mt-3 text-xs md:text-sm text-slate-300"
              >
              ...
              >
                <span className="font-semibold text-slate-100">Tech stack:</span>{" "}
                {project.techStackShort}
              </CardItem>
              ...
              <div className="mt-2 flex items-center justify-between">
                ...
                <CardItem
                  ...
                  className="text-xs md:text-sm text-emerald-300 hover:text-emerald-200 underline underline-offset-4"
                >
                  View case study
                </CardItem>
              </div>
